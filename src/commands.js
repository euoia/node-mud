...
function load() {
    return __awaiter(this, void 0, void 0, function () {
        var readdirAsync, files;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    readdirAsync = Bluebird.promisify(fs.readdir);
                    return [4 /*yield*/, readdirAsync(commandsPath).map(function (f) { return path.join(commandsPath, f); })];
                case 1:
                    files = _a.sent();
...
function handle(command, player) {
    ...
    var failMessage = "What?";
    var fail = function (failString) {
